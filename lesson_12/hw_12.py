...
driver.find_element("xpath", "//a[@href='#example-4']").click()
...
SLIDER_LOCATOR = ("xpath", "(//div[@id='example-4']//div[@role='slider'])[1]")
time.sleep(3)
move_slider(SLIDER_LOCATOR, current_point_atr_name="aria-valuenow", target_point=10)
time.sleep(5)
